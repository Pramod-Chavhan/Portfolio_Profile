...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Flask + React home sample collection scheduler for diagnostic centers — Google Maps agent assignment, Random Forest delivery prediction, Twilio SMS, and Firebase booking.",
    image: "/ASFSK.png",
  ...
  },
  {
    ...
    description:
      "Real-time attendance with OpenCV and insightFace ResNet-34 — Flask backend, Firebase logging, and React admin dashboard for 1000+ students.",
    image: "/facereg.jpg",
  ...
  },
  {
    ...
    description:
      "IoT irrigation for Punjab farms — Raspberry Pi sensors, Random Forest predictions via OpenWeather API, and Flask remote access to cut water use and boost yield.",
  ...
  },
  {
    ...
    description:
      "Fine-tuned BERT for medical document Q&A — PDFs, Word, JSON via FastAPI, with Pinecone storage and sub-2s answers for clinicians.",
